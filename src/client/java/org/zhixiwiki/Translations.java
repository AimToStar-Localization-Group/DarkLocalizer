...
public class Translations {
    public static Map<String, Text> translations = Map.ofEntries(
            ...
            entry("Right-click to activate Water Breathing.", Text.literal("右击获得水下呼吸。")),
            ...
            entry("Right-click to activate Absorption.", Text.literal("右击获得伤害吸收。")),
            entry("Demon Slayer Katana", Text.literal("斩魔武士刀")),
            entry("Right-click to activate Regeneration.", Text.literal("右击获得生命恢复。")),
            ...
            entry("Right-click while sneaking to activate Haste.", Text.literal("潜行时右击获得急迫。")),
            ...
            entry("Ember Cannon: Grants Absorption", Text.literal("余火加农炮：使用后获得")),
            entry("Health Boost and Regeneration when used.", Text.literal("伤害吸收，生命提升和生命恢复。")),
            ...
            entry("and Regeneration when used", Text.literal("抗性提升和生命恢复")),
            ...
            entry("Useful for crafting Dark Netherite Armor.", Text.literal("用于合成暗黑下界合金护甲。")),
            entry("Rogue's Bane", Text.literal("盗贼灾星")),
            entry("Right-click to activate Speed.", Text.literal("右击获得速度。")),
